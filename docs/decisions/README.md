...
- [0034 — Sensor-Registrierung: systematische Bias-Schätzung vor der Fusion](0034-sensor-registrierung-bias-schaetzung.md)
- [0035 — Constant-Acceleration-Modell: 6-D-Zustand in der IMM-Bank](0035-ca-modell-6d-imm-bank.md)
- [0036 — Identität als weicher Schlüssel + JPDA-Koaleszenz-Wächter](0036-duplikat-identitaeten-koaleszenz.md)
- [0037 — Räumliche Clutter-Karte + Multipath-Reflexions-Heuristik](0037-raeumliche-clutter-karte-reflexionen.md)
- [0038 — Flugplan-Korrelation zentral im SDPS (Firefly), nicht am CWP](0038-korrelation-im-sdps-vs-cwp.md)
- [0039 — CAT062-Flugplan-Ausleitung (I062/390) + manueller Korrelations-Rand](0039-cat062-flugplan-ausleitung-manueller-rand.md)
- [0040 — Zustands-Snapshot + Wiederanlauf (HA.1)](0040-zustands-snapshot-restore.md)
- [0041 — Main/Standby über Heartbeat-Wache (HA.2)](0041-main-standby-heartbeat-failover.md)
- [0042 — Arbeitsteilung Firefly + Wayfinder = SDPS-Server-Funktion (CAT252-Ersatz)](0042-arbeitsteilung-sdps-server-funktion.md)
