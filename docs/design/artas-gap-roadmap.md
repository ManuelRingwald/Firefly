...
| | REG.2b | Korrektur **vor der Fusion** mit Anwendungs-Politik (Beobachtbarkeit, Mindest-Evidenz, signifikanter RMS-Gewinn, geglättete Übergänge) + Konvergenz-Tests | S5 · Fable 5 / Opus 4.8 | **40 %** | ⏳ |
