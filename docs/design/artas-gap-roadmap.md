...
| | VERT.3 | Mode of Movement + Beschleunigung → I062/200/210: Beschleunigungs-Schätzer (EWMA über d/dt der IMM-Kombinationsgeschwindigkeit, < 0,5-s-Samples übersprungen), TRANS aus CT-Modellwahrscheinlichkeiten (Drehung erst bei µ > 0,5), LONG along-track (0,2 m/s², erst ab 5 m/s), VERT aus Vertikal-Filter-Rate (±300 ft/min); I062/200 nur wenn eine Achse bestimmt, I062/210 i8 × 0,25 m/s² mit Sättigung (ICD 3.6.0 additiv, byte-genaue Vektoren; FR-TRK-043). *CA-Modell in der IMM-Bank bewusst zurückgestellt (6-D-Zustand schneidet durch den 4-D-Fusionskern) — Folge-Häppchen mit eigenem ADR; keine Trend-Hysterese; ADF immer 0.* | S4–S5 · Fable 5 | **66,5 %** | ✅ 2026-07-11 |
