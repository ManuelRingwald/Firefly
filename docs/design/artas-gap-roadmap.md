...
| | VERT.4b | **Tracking-Hälfte, Integration:** IMM-Bank auf `LinearKalman6` (Weg A: alle Modelle 6-D, Mischung bleibt dimensionsrein), CA-Modell in `ImmConfig` (Transition/Prior-Tuning, Jerk-PSD-Kalibrierung), Kombination + 4-D-Projektion am Bank-Rand, **I062/210 aus dem Filterzustand** statt aus dem VERT.3-Ableiter (der als LONG-Trend-Quelle bleibt), End-to-End-Tests (Beschleunigungs-Szenario: Prädiktions-Lag-Gewinn messbar); Snapshot-Layout-Wechsel (vor HA.1 billig). Erst dieses Häppchen ändert Verhalten. | S5 · Fable 5 | **66,5 %** | ⏳ |
