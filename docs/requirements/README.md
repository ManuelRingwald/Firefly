...
| FR-IO-003 | Der Tracker-Ausgabestrom wird zusätzlich als **ASTERIX CAT062** (binäre System-Tracks) kodiert — der Andock-Kontrakt ans ASD (ADR 0006). Eigene Crate `firefly-asterix`, neben dem JSON-Adapter, auf demselben neutralen `SystemTrack`; bit-genaues Framing (`[CAT][LEN][Record]`) mit FSPEC/UAP-Mechanik. Felder: I062/010, /070, /105, /185, /040, /080, /290, /500; **Identität** (nur bei vorhandener SSR-Identität, FR-TRK-009): I062/060 (Mode 3/A) und I062/380/ADR (Mode-S-24-Bit-Adresse als Target-Address-Subfeld). | fertig (3.X.1–3.X.4 + 4.2; LSB-/Subfeld-Werte von /290, /500, /060 und /380/ADR gegen EUROCONTROL SUR.ET1.ST05.2000-STD-09-01 Ed. 1.10 verifiziert; Meilenstein-Doku `docs/milestones/M3X-cat062-encoder.md`) | `firefly-asterix`: `fspec::*`, `cat062::single_track_matches_reference_dump`, `cat062::time_of_track_scales_to_128th_seconds`, `cat062::position_scales_to_wgs84_lsb_and_signs_via_twos_complement`, `cat062::velocity_scales_to_quarter_mps_and_signs_via_twos_complement`, `cat062::track_status_carries_cnf_and_extends_for_cst`, `cat062::update_ages_use_psr_subfield_in_quarter_seconds`, `cat062::accuracies_use_apc_subfield_in_half_metres`, `cat062::mode_3a_carries_the_octal_reply_in_low_twelve_bits`, `cat062::target_address_uses_adr_subfield_with_24_bit_address`, `cat062::identity_items_appear_only_when_present`, `cat062::length_field_covers_all_records` |
