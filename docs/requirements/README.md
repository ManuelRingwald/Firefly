...
| FR-IO-003 | Der Tracker-Ausgabestrom wird zusätzlich als **ASTERIX CAT062** (binäre System-Tracks) kodiert — der Andock-Kontrakt ans ASD (ADR 0006). Eigene Crate `firefly-asterix`, neben dem JSON-Adapter, auf demselben neutralen `SystemTrack`; bit-genaues Framing (`[CAT][LEN][Record]`) mit FSPEC/UAP-Mechanik. | in Arbeit (3.X.1: Framing + FSPEC + I062/010, /070, /040; 3.X.2: I062/105 Position + I062/185 Geschwindigkeit; Status-Felder folgen 3.X.3) | `firefly-asterix`: `fspec::single_first_item_sets_the_top_bit`, `fspec::crossing_into_the_second_octet_sets_fx`, `fspec::octet_boundary_is_at_frn_seven`, `fspec::builder_orders_payloads_by_frn`, `cat062::single_track_matches_reference_dump`, `cat062::time_of_track_scales_to_128th_seconds`, `cat062::position_scales_to_wgs84_lsb_and_signs_via_twos_complement`, `cat062::velocity_scales_to_quarter_mps_and_signs_via_twos_complement`, `cat062::length_field_covers_all_records` |
