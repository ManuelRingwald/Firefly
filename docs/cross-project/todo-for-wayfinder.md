...
| Issue | Thema | Status |
|-------|-------|--------|
| [Firefly#55](https://github.com/ManuelRingwald/Firefly/issues/55) (`from-wayfinder`) | **CAT063-UAP-Standardisierung, ICD 3.0.0 (BREAKING, ADR 0032):** Sensor-Status-Records folgen jetzt den echten EUROCONTROL-FRN-Slots. I063/010 = **SDPS**-Identität (SAC/SIC wie I062/010, Default 25/2), Sensor-Identität wandert ins neue **I063/050** (FRN 4); I063/030 → FRN 3, I063/060 → FRN 5. FSPEC `0xE0` → **`0xB8`**, Record 7 → 9 Oktette; CON-Werte auf Standard (`0` op/`1` degr./`2` init/`3` not-conn.). Fundament für den Grund-Code je ausgefallener Quelle (Wayfinder #197 → ADR 0033, RE-Feld, additiv). **Wayfinder-Folge (H2, lockstep):** CAT063-Decoder liest Sensor aus I063/050, erwartet FSPEC `0xB8`, überspringt RE/SP längen-tolerant. Firefly-first mergen+deployen, Wayfinder unmittelbar danach. | ⏳ Firefly fertig (H1); Wayfinder H2 offen |
