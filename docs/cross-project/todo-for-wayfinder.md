...
| Issue | Thema | Status |
|-------|-------|--------|
| *(Issue folgt — GitHub-API bei Abschluss nicht erreichbar)* (`from-firefly`) | **CAT063 ICD 3.3.0 (additiv, FR-IO-008, REG.3/ADR 0034):** Bei aktiver Registrierungs-Korrektur (REG.2b) trägt der CAT063-Record je Radar die **angewandte Bias-Korrektur** in **I063/080** (FRN 7: SRG=0 + SRB, i16 BE, LSB 1/128 NM ≈ 14,47 m) und **I063/081** (FRN 8: SAB, i16 BE, LSB 360/2¹⁶ ° ≈ 0,0055°). Nur bei in Kraft befindlicher Korrektur gesendet — **Absenz = „keine Korrektur"**; FSPEC dann `0xBB 0x80`, Record 16 Oktette; byte-genauer Referenz-Dump in ICD §9. Kein Wire-Bruch, kein Lockstep. Wayfinder: CAT063-Decoder um FRN 7/8 erweitern (feste Längen), Bias je Sensor im Sensor-/Feed-Panel anzeigen (z. B. „Δr +145 m · Δθ +0,30°"). Baut auf WF-1…3 (#72) auf. S2–S3. | ⏳ offen (Issue ausstehend) |
